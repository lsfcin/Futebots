...
p1 = player.Player(circle.Circle(30, 200, 200, 1.6, 100, -1.1 ), 1, 0.1, 2)
p2 = player.Player(circle.Circle(25, 100, 200, 1.9, 100,  1.1 ), 1, 0.1, 2)
p3 = player.Player(circle.Circle(15, 200, 100, 1.0, 100,  1.01), 1, 0.1, 2)
p4 = player.Player(circle.Circle(30, 400, 400, 0.6, 100,  1.2 ), 2, 0.1, 2)
p5 = player.Player(circle.Circle(25, 450, 450, 0.1, 100, -1.01), 2, 0.1, 2)
p6 = player.Player(circle.Circle(20, 400, 200, 2.6, 150,  1.05), 2, 0.1, 2)
